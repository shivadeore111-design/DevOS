...
exports.llmExtractor = exports.LLMExtractor = void 0;
...
class LLMExtractor {
     ...
     */
    async extractSearchResults(html, query) {
     ...
     */
    async extractContent(html, instructions) {
        const truncated = html.slice(0, HTML_TRUNC);
        const prompt = `${instructions}\n\nHTML content:\n${truncated}`;
        try {
            return await (0, ollama_1.callOllama)(prompt, undefined, EXTRACT_MODEL);
        }
        catch (err) {
...
exports.llmExtractor = new LLMExtractor();

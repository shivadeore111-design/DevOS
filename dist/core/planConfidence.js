...
class PlanConfidence {
    ...
    score(plan, parsedGoal) {
        ...
        if (fileWrites.length === 0 || allHaveContent)
            total += 0.2;
        // ── 4. No high-risk actions ──────────────────────────
        const hasHighRisk = actions.some(a => {
            const assessment = riskEvaluator_1.riskEvaluator.evaluate(a);
...
exports.PlanConfidence = PlanConfidence;
exports.planConfidence = new PlanConfidence();

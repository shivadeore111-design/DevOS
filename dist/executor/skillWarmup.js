...
exports.skillWarmup = exports.SkillWarmup = void 0;
...
const SKILLS_DIR = path_1.default.join(process.cwd(), "skills");
...
class SkillWarmup {
     ...
     */
    _resolveTopSkills() {
        const patternsFile = path_1.default.join(process.cwd(), "workspace", "memory", "taskPatterns.json");
        try {
            if (fs_1.default.existsSync(patternsFile)) {
                const raw = fs_1.default.readFileSync(patternsFile, "utf-8");
        ...
        try {
            return fs_1.default.readdirSync(SKILLS_DIR)
                .filter(e => {
                try {
                    return fs_1.default.statSync(path_1.default.join(SKILLS_DIR, e)).isDirectory();
                }
                catch {
                    return false;
                }
     ...
     */
    _resolveSkillPath(name) {
        const candidates = [
            path_1.default.join(SKILLS_DIR, `${name}.ts`),
            path_1.default.join(SKILLS_DIR, name, "index.ts"),
            path_1.default.join(SKILLS_DIR, `${name}.js`),
            path_1.default.join(SKILLS_DIR, name, "index.js"),
        ];
...
exports.SkillWarmup = SkillWarmup;
exports.skillWarmup = new SkillWarmup();

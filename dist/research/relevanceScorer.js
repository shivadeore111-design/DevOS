...
exports.relevanceScorer = exports.RelevanceScorer = void 0;
class RelevanceScorer {
    score(results, goal, parsedGoal) {
    ...
    scoreOne(result, keywords, stack) {
        let score = 0;
        const reasons = [];
...
exports.relevanceScorer = new RelevanceScorer();
